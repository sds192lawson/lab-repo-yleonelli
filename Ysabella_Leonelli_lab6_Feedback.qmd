...
pit_pivoted <- pit |> pivot_longer(cols = -State,
                                   names_to = "Measure",
                                   values_to = "Value")
##TA Feeback: Nice job, remember you can also exclude the state column using an indexing argument instead +3
#Alternative pivo arguements
  #pivot_longer(2:117, 
               #names_to = "Measure", 
               #values_to = "Value")
##Total for Q1: 2 pts
...
pit_by_race <- pit_str_cleaned |> filter(Demographic %in% c("Black or African American", 
  "Asian", 
  "American Indian or Alaska Native", 
  "Native Hawaiian or Other Pacific Islander", 
  "White", 
...
```{r}
# Step 1
gender_pivoted_longer <- gender |> pivot_longer(estimate_2015:moe_2020, names_to = "Measure", values_to = "Values")
...
# Step 1
race_pivoted_longer <- race |> pivot_longer(estimate_2015:moe_2020, names_to = "Measure", values_to = "Values")
